...
export declare class Router {
     ...
     */
    updateCalendarEventRsvpMany(channelId: string, calendarEventId: number, options: RESTPatchCalendarEventRsvpManyBody): Promise<RESTPatchCalendarEventRsvpManyResult>;
    /**
    ...
    getMe(): Promise<RESTGetUserResult>;
    /**
