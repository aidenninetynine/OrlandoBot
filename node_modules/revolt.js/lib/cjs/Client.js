...
class Client extends eventemitter3_1.default {
    ...
    constructor(options, configuration) {
        ...
        this.options = Object.assign({ baseURL: "https://api.revolt.chat", partials: false, eagerFetching: true, syncUnreads: false, autoReconnect: true, 
            /**
        ...
        this.bots = new collections_1.BotCollection(this);
        this.channels = new collections_1.ChannelCollection(this);
        this.channelUnreads = new collections_1.ChannelUnreadCollection(this);
        this.emojis = new collections_1.EmojiCollection(this);
        this.messages = new collections_1.MessageCollection(this);
        this.users = new collections_1.UserCollection(this);
        this.servers = new collections_1.ServerCollection(this);
        this.serverMembers = new collections_1.ServerMemberCollection(this);
        this.events = new events_1.EventClient(1, "json", this.options);
        this.events.on("error", (error) => this.emit("error", error));
        this.events.on("state", (state) => {
            switch (state) {
                case events_1.ConnectionState.Connected:
                    __classPrivateFieldGet(this, _Client_setConnectionFailureCount, "f").call(this, 0);
                    this.emit("connected");
                    break;
                case events_1.ConnectionState.Connecting:
                    this.emit("connecting");
                    break;
                case events_1.ConnectionState.Disconnected:
        ...
        this.events.on("event", (event) => (0, events_1.handleEventV1)(this, event, __classPrivateFieldGet(this, _Client_setReady, "f")));
    }
    /**
     * Connect to Revolt
     */
    ...
    markdownToText(source) {
        return source
            .replace(regex_1.RE_MENTIONS, (sub, id) => {
            ...
            .replace(regex_1.RE_CHANNELS, (sub, id) => {
            ...
            .replace(regex_1.RE_SPOILER, "<spoiler>");
    }
    /**
