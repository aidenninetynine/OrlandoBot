...
class Server {
    ...
    edit(data) {
        return __awaiter(this, void 0, void 0, function* () {
            yield __classPrivateFieldGet(this, _Server_collection, "f").client.api.patch(`/servers/${this.id}`, data);
        });
    }
    /**
    ...
    fetchMembers() {
        return __awaiter(this, void 0, void 0, function* () {
            const data = yield __classPrivateFieldGet(this, _Server_collection, "f").client.api.get(`/servers/${this.id}/members`);
            return {
    ...
    fetchEmojis() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return emojis.map((emoji) => __classPrivateFieldGet(this, _Server_collection, "f").client.emojis.getOrCreate(emoji._id, emoji));
        });
    }
}
exports.Server = Server;
_Server_collection = new WeakMap();
