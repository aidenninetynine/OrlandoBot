...
import type { RESTGetCalendarEventsBody, RESTPatchCalendarEventBody, RESTPostCalendarEventBody, RESTPatchCalendarEventRsvpBody, RESTPatchCalendarEventRsvpManyBody } from "@guildedjs/guilded-api-typings";
...
export declare class GlobalCalendarManager extends CacheableStructManager<number, CalendarEvent> {
     ...
     */
    updateManyRsvp(channelId: string, calendarEventId: number, options: RESTPatchCalendarEventRsvpManyBody): Promise<void>;
    /**
