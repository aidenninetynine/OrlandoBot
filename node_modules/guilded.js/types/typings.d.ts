import type { DocPayload, EmbedPayload, ListItemPayload, ListItemSummaryPayload, RESTPostChannelMessagesBody, ServerMemberBanPayload, ServerMemberPayload, ServerMemberRoleIdsPayload, ServerMemberSummaryPayload, SocialLink } from "@guildedjs/guilded-api-typings";
...
export type ClientEvents = {
    ...
    memberSocialLinkCreated: (serverId: string, socialLink: SocialLink) => unknown;
    memberSocialLinkUpdated: (serverId: string, socialLink: SocialLink) => unknown;
    memberSocialLinkDeleted: (serverId: string, socialLink: SocialLink) => unknown;
