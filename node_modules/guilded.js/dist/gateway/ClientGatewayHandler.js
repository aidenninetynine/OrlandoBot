...
class ClientGatewayHandler {
    constructor(client) {
        ...
        this.eventToHandlerMap = {
            ...
            [guilded_api_typings_1.WebSocketEvents.ServerMemberSocialLinkCreated]: (data) => this.ServerMemberHandler.serverMemberSocialLinkCreated(data),
            [guilded_api_typings_1.WebSocketEvents.ServerMemberSocialLinkUpdated]: (data) => this.ServerMemberHandler.serverMemberSocialLinkUpdated(data),
            [guilded_api_typings_1.WebSocketEvents.ServerMemberSocialLinkDeleted]: (data) => this.ServerMemberHandler.serverMemberSocialLinkDeleted(data),
