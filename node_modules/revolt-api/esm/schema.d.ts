...
export interface components {
    schemas: {
         ...
         * @enum {string}
         */
        ContentReportReason: "NoneSpecified" | "Illegal" | "PromotesHarm" | "SpamAbuse" | "Malware" | "Harassment";
        /**
         * @description Reason for reporting a user
         * @enum {string}
         */
        UserReportReason: "NoneSpecified" | "SpamAbuse" | "InappropriateProfile" | "Impersonation" | "BanEvasion" | "Underage";
        /** Report Data */
        DataEditReport: {
